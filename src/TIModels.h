...
namespace tivars
{
    ...
    enum TIFeatureFlags
    {
        blablabla = 0b00000001, // (1 << 0);
      /*
        blablabla = 0b00000010, // (1 << 1);
        blablabla = 0b00000100, // (1 << 2);
        blablabla = 0b00001000, // (1 << 3);
        blablabla = 0b00010000, // (1 << 4);
        blablabla = 0b00100000, // (1 << 5);
        blablabla = 0b01000000, // (1 << 6);
        blablabla = 0b10000000, // (1 << 7);
    */
    };
